...
Java_com_fluper_imagefilterapp_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_fluper_imagefilterapp_imageprocessors_NativeImageProcessor_applyRGBCurve(JNIEnv *env,
                                                                                  jclass clazz,
                                                                                  jintArray pixels,
                                                                                  jintArray rgb,
                                                                                  jint width,
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_fluper_imagefilterapp_imageprocessors_NativeImageProcessor_applyChannelCurves(JNIEnv *env,
                                                                                       jclass clazz,
                                                                                       jintArray pixels,
                                                                                       jintArray r,
                                                                                       jintArray g,
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_fluper_imagefilterapp_imageprocessors_NativeImageProcessor_doBrightness(JNIEnv *env,
                                                                                 jclass clazz,
                                                                                 jintArray pixels,
                                                                                 jint value,
                                                                                 jint width,
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_fluper_imagefilterapp_imageprocessors_NativeImageProcessor_doContrast(JNIEnv *env,
                                                                               jclass clazz,
                                                                               jintArray pixels,
                                                                               jfloat value,
                                                                               jint width,
...
extern "C"
JNIEXPORT jintArray JNICALL
Java_com_fluper_imagefilterapp_imageprocessors_NativeImageProcessor_doColorOverlay(JNIEnv *env,
                                                                                   jclass clazz,
                                                                                   jintArray pixels,
                                                                                   jint depth,
                                                                                   jfloat red,
...
JNIEXPORT jintArray JNICALL
Java_com_fluper_imagefilterapp_imageprocessors_NativeImageProcessor_doSaturation(JNIEnv *env,
                                                                                 jclass clazz,
                                                                                 jintArray pixels,
                                                                                 jfloat level,
                                                                                 jint width,
